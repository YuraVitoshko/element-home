(() => {
    ...
    function initSliders() {
        if (document.querySelector(".popular__slider")) new core(".popular__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-buttons-popular__button--left",
                nextEl: ".slider-buttons-popular__button--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".testmonials__slider")) new core(".testmonials__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-buttons-testmonials__button--left",
                nextEl: ".slider-buttons-testmonials__button--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".good__images")) {
            new core(".images-good__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".images-good__swiper-button-prev",
                    nextEl: ".images-good__swiper-button-next"
                },
                on: {}
            });
            new core(".images-preview__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
